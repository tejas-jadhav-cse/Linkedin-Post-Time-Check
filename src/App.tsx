...
function App() {
  ...
  return (
    <div className={`min-h-screen transition-all duration-500 ${
      ...
      {/* Minimal Navigation */}
      <nav className={`py-6 ${darkMode ? 'bg-gray-900/50' : 'bg-white/50'} backdrop-blur-md fixed w-full top-0 z-10`}>
      ...
      <div className="container py-28 mt-6">
        <div className="text-center fade-in container-sm">
          <h1 className={`text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight mb-4 ${
            ...
            Extract <span className="text-blue-600">LinkedIn</span>
          </h1>
          ...
          <div className="container-sm mb-16 fade-in" style={{animationDelay: "0.2s"}}>
            <div className={`p-8 rounded-2xl backdrop-blur-md shadow-lg ${
              darkMode 
              ...
              <div className="space-y-6">
                ...
                <button
                  ...
                  className={`w-full py-4 px-8 text-md font-medium rounded-full transition-all duration-300 pulse-button ${
                    loading || !url.trim()
        ...
        {result && (
          <div className="container-sm mb-16 fade-in" style={{animationDelay: "0.3s"}}>
            <div className={`p-6 rounded-2xl backdrop-blur-md shadow-lg ${
              darkMode 
                ? 'bg-gray-800/40 border border-gray-700/30' 
                : 'bg-white/70 border border-gray-100/50'
            } card`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className={`p-4 rounded-xl transition-all ${
                  darkMode ? 'bg-gray-700/30 hover:bg-gray-700/40' : 'bg-gray-50/70 hover:bg-gray-100/70'
                }`}>
                ...
                <div className={`p-4 rounded-xl transition-all ${
                  ...
                  <p className={`text-md font-mono overflow-auto ${darkMode ? 'text-gray-200' : 'text-gray-800'}`}>
                    {result.iso}
                  </p>
                </div>
                ...
                <div className={`p-4 rounded-xl transition-all ${
                  ...
                  <p className={`text-md ${darkMode ? 'text-gray-200' : 'text-gray-800'}`}>
                    {result.local}
                  </p>
                </div>
                    ...
                    <div
                      ...
                      className={`p-3 rounded-lg cursor-pointer transition-all duration-300 hover:translate-x-1 ${
                        darkMode 
                          ...
                          : 'hover:bg-gray-100/70 bg-gray-50/50'
                      }`}
                    >
        ...
        <div className="container fade-in" style={{animationDelay: "0.4s"}}>
          <div className="max-w-xl mx-auto">
            <div className="text-center mb-10">
              <h3 className={`text-2xl font-medium mb-3 ${darkMode ? 'text-white' : 'text-gray-800'}`}>
                Features
              </h3>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-4 transition-all duration-300 hover:translate-y-[-5px]">
                ...
                <h4 className={`text-md font-medium mb-1 ${darkMode ? 'text-white' : 'text-gray-800'}`}>
                  Lightning Fast
                </h4>
      ...
      <footer className={`mt-auto py-6 ${darkMode ? 'bg-gray-900/30' : 'bg-gray-50/50'} backdrop-blur-sm`}>
        <div className="container">
          <div className="text-center max-w-xs mx-auto">
            ...
            <p className={`text-xs ${darkMode ? 'text-gray-500' : 'text-gray-500'}`}>
              © 2025 LinkedIn Timestamp Extractor
            </p>
          </div>
        </div>
      </footer>
